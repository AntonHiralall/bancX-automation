    ...
    test.describe('Valid Scenarios', () => {
        test('Should successfully submit form with standard income', async ({ page }) => {
            ...
            await test.step('Verify form is properly filled', async () => {
                expect(await financialInfoPage.areRequiredFieldsFilled(), 'All required fields should be filled with standard income data').toBeTruthy();
            });

            await test.step('Submit form and verify no errors', async () => {
                await financialInfoPage.clickNext();
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should not be displayed when submitting valid standard income data').toBeFalsy();
            });
            ...
            await test.step('Assertions on loan calculator screen', async () => {
                await financialInfoPage.waitForPageLoad();
                await expect(financialInfoPage.validateAffordabilityText(), 'Affordability text should be visible').toBeTruthy();
                await expect(financialInfoPage.validateLoanAmountText(), 'Loan amount text should be visible').toBeTruthy();
                await expect(financialInfoPage.validateLoanTermText(), 'Loan term text should be visible').toBeTruthy();
                await expect(financialInfoPage.validateLoanInstalmentText(), 'Loan instalment text should be visible').toBeTruthy();
        ...
        test('Should successfully submit form with high income', async ({ page }) => {
            ...
            await test.step('Submit form and verify no errors', async () => {
                await financialInfoPage.clickNext();
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should not be displayed when submitting valid high income data').toBeFalsy();
            });
        });
        ...
        test('Should successfully submit form with low income', async ({ page }) => {
            ...
            await test.step('Submit form and verify no errors', async () => {
                await financialInfoPage.clickNext();
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should not be displayed when submitting valid low income data').toBeFalsy();
            });
        });
    });
    ...
    test.describe('Invalid Scenarios', () => {
        ...
        test('Should show error with invalid amounts', async ({ page }) => {
            ...
            await test.step('Verify error message is displayed', async () => {
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should be displayed when submitting invalid amounts data').toBeTruthy();
            });
        });
        ...
        test('Should show error with negative amounts', async ({ page }) => {
            ...
            await test.step('Verify error message is displayed', async () => {
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should be displayed when submitting negative amounts data').toBeTruthy();
            });
        });
        ...
        test('Should show error with special characters', async ({ page }) => {
            ...
            await test.step('Verify error message is displayed', async () => {
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should be displayed when submitting special characters data').toBeTruthy();
            });
        });
    });
    ...
    test.describe('Edge Cases', () => {
        test('Should handle maximum amounts', async ({ page }) => {
            ...
            await test.step('Verify form behavior with maximum amounts', async () => {
                ...
                expect(await financialInfoPage.isExpensesEqualsIncomeValidationMessageVisible(), 'Expenses equals income validation message should be visible for maximum amounts').toBeTruthy();
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should be displayed when submitting maximum amounts data').toBeTruthy();
            });
        });
        ...
        test('Should handle minimum amounts', async ({ page }) => {
            ...
            await test.step('Verify form behavior with minimum amounts', async () => {
                ...
                expect(await financialInfoPage.isExpensesEqualsIncomeValidationMessageVisible(), 'Expenses equals income validation message should be visible for minimum amounts').toBeTruthy();
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should be displayed when submitting minimum amounts data').toBeTruthy();
            });
        });
        ...
        test('Should handle zero amounts', async ({ page }) => {
            ...
            await test.step('Verify form behavior with zero amounts', async () => {
                expect(await financialInfoPage.isExpensesEqualsIncomeValidationMessageVisible(), 'Expenses equals income validation message should be visible for zero amounts').toBeTruthy();
                expect(await financialInfoPage.isErrorMessageVisible(), 'Error message should be displayed when submitting zero amounts data').toBeTruthy();
            });
        });
    });
    ...
    test.describe('Form Field Validation', () => {
        test('Should clear all fields when reset', async ({ page }) => {
            ...
            await test.step('Verify all fields are cleared', async () => {
                expect(await financialInfoPage.areRequiredFieldsFilled(), 'All required fields should be cleared').toBeFalsy();
            });
        });
